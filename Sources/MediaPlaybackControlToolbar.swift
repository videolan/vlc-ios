...
@objcMembers class MediaPlaybackControlToolbar: UIStackView {
    ...
    private let playbackController = VLCPlaybackController.sharedInstance()
    ...
    private func addObsersers() {
        let resumeNotification = Notification.Name(rawValue: VLCPlaybackControllerPlaybackDidResume)
        let pauseNotification = Notification.Name(rawValue: VLCPlaybackControllerPlaybackDidPause)
        let playbackStartNotification = Notification.Name(rawValue: VLCPlaybackControllerPlaybackDidStart)
    ...
    @objc private func handleNotification(_ notification: Notification) {
        var isPlaying = notification.name.rawValue == VLCPlaybackControllerPlaybackDidResume
        isPlaying = isPlaying || notification.name.rawValue == VLCPlaybackControllerPlaybackDidStart
